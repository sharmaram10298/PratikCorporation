                            ...
                            <form id="myForm" method="post" action="{{route('update.banner')}}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="banner_title" class="form-control"  value="{{ $data->banner_title }}" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class=" form-group col-sm-9 text-secondary">
                                        <input type="text" name="banner_url" class="form-control" value="{{ $data->banner_url }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ asset($data->banner_image)   }}" alt="sbanner"
