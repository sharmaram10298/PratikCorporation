...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Add New Vendor</div>
        <div class="ps-3">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <hr />
            <form id="myForm" action="{{route('vendor.register')}}" method="post" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-lg-12">
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    <div class="col ">
                                        <input type="hidden" name="role" value="Vendor" class="form-control" id="email" placeholder="Enter role" >
                                    </div>
