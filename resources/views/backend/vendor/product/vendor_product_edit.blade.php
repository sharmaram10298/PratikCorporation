...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group">
                <a href="{{ route('vendor.all.product') }}" class="btn btn-primary">Back</a>
            </div>
        </div>
                            ...
                            <div class="border border-3 p-4 rounded">
                                ...
                                <div class="row g-3 mb-3">
                                    <div class="col">
                                        ...
                                        <input type="text" name="brand" class="form-control" id="brand" value="{{ $products->brand }}">
                                    </div>
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">Article </label>
                                        <input type="text" name="article" class="form-control" id="article" value="{{ $products->article }}">
                                    </div>
                                </div>
                                <div class="row g-3 mb-3">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="stock" class="form-control" id="stock" value="{{ $products->stock }}">
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="category" class="form-control" id="category" value="{{ $products->category }}">
                                    </div>
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">cage Name</label>
                                        <input type="text" name="cage" class="form-control" id="cage" value="{{ $products->cage }}">
                                    </div>
                                ...
                                <div class="row g-3 mb-3">
                                    <div class="col">
                                        ...
                                        <input type="text" name="temperature_range" class="form-control" id="temperature_range" value="{{ $products->temperature_range }}">
                                    </div>
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">tolerance_class</label>
                                        <input type="text" name="tolerance_class" class="form-control" id="tolerance_class" value="{{ $products->tolerance_class }}">
                                    </div>
                                </div>
                                <div class="row g-3 mb-3">
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">roller_rows</label>
                                        <input type="text" name="roller_rows" class="form-control" id="roller_rows" value="{{ $products->roller_rows }}">
                                    </div>
                                    <div class="col">
                                ...
                                <div class="row g-3 mb-3">
                                    <div class="col">
                                        ...
                                        <input type="text" name="arrangement" class="form-control" id="arrangement" value="{{ $products->arrangement }}">
                                    </div>
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">weight</label>
                                        <input type="text" name="weight" class="form-control" id="weight" value="{{ $products->weight }}">
                                    </div>
                                </div>
                                <div class="row g-3 mb-3">
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">productid</label>
                                        <input type="text" name="productid" class="form-control" id="productid" value="{{ $products->productid }}">
                                    </div>
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">country_of_origin</label>
                                        <input type="text" name="country_of_origin" class="form-control" id="country_of_origin" value="{{ $products->country_of_origin }}">
                                    </div>
                                </div>
                                <div class="row g-3 mb-3">
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">customs_tariff_number </label>
                                        <input type="text" name="customs_tariff_number" class="form-control" id="customs_tariff_number" value="{{ $products->customs_tariff_number }}">
                                    </div>
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">manufacturer_part_number</label>
                                        <input type="text" name="manufacturer_part_number" class="form-control" id="manufacturer_part_number" value="{{ $products->manufacturer_part_number }}">
                                    </div>
                                </div>
                                <div class="row g-3 mb-3">
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">inner_dimension</label>
                                        <input type="text" name="inner_dimension" class="form-control" id="inner_dimension" value="{{ $products->inner_dimension }}">
                                    </div>
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">outer_dimension</label>
                                        <input type="text" name="outer_dimension" class="form-control" id="outer_dimension" value="{{ $products->outer_dimension }}">
                                    </div>
                                    <div class="col">
                                        <label for="inputProductTitle" class="form-label">width</label>
                                        <input type="text" name="width" class="form-control" id="width" value="{{ $products->width }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row g-3 mb-3">
