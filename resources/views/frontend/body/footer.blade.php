...
<footer class="footer footer_type_1">
    <div class="container pt-5 pb-4">
        <div class="row">
            <div class="col-lg-6">
                <div class="logo">
                    <a href="#">
                        <img src="{{ asset('frontend/assets/images/logo.png')}}" style="margin-bottom: 30px;" alt="Uomo"
                            class="logo__image d-block" />
                    </a>
                </div><!-- /.logo -->
                <p class="footer-address">Global Street 5004, Newyork, United States.</p>

                <p class="m-0">
                    <strong class="fw-medium" style="color: #C4C4C4;">+0 625-07520-6644</strong> <span
                        style="color: #C4C4C4;">|</span> <strong class="fw-medium"
                        style="color: #C4C4C4;">pratikcorporation@gmail.com</strong>
                </p>
                <p class="footer-address">Visit Our Office:</p>
                <p class="footer-address">Monday - Saturday: 9.00am to 5.00pm</p>
            ...
            <div class="col-lg-3">
                <h5 class="sub-menu__title upper">Usefull Links</h5>
                <hr style="width: 35px;color: #E30000;height: 4px;margin-top: 0px;opacity: 1;margin-left: 5px;">
            ...
            <div class="col-lg-3">
                <h5 class="sub-menu__title upper">Our Materials</h5>
                <hr style="width: 35px;color: #E30000;height: 4px;margin-top: 0px;opacity: 1;margin-left: 5px;">
                <ul class="sub-menu__list list-unstyled">
                    <li class="sub-menu__item"><a href="#" class="menu-link menu-link_us-s">About Us</a></li>
                    <li class="sub-menu__item"><a href="#" class="menu-link menu-link_us-s">Careers</a></li>
    ...
    <div class="footer-bottom">
        <div class="text-center">
            <span class="footer-copyright me-auto">Copyright © 2023 Pratik Corporation. All rights reserved.</span>
        </div><!-- /.d-flex -->
...
<footer class="footer-mobile container w-100 px-5 d-md-none bg-body">
    <div class="row text-center">
        <div class="col-4">
            <a href="https://uomo-html.flexkitux.com/" class="footer-mobile__link d-block">
...
<div class="aside aside_right overflow-hidden cart-drawer" id="cartDrawer">
    ...
    <div class="aside-content cart-drawer-items-list">
        ...
        <div class="cart-drawer-item d-flex position-relative">
            <div class="position-relative">
                <img loading="lazy" class="cart-drawer-item__img" src="frontend/assets/images/cart-item-2.jpg" />
            </div>
            <div class="cart-drawer-item__info flex-grow-1">
                            ...
                            <div class="tab-pane fade show active" id="pills-item-1" role="tabpanel"
                                ...
                                <div class="row">
                                    <ul class="nav nav-tabs list-unstyled col-5 d-block" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item position-relative" role="presentation">
                                            <a class="nav-link nav-link_rline" href="#"><span class="rline-content">JOIN
                                                    LIFE</span></a>
                                        </li>
                                        <li class="nav-item position-relative" role="presentation">
                                            <a class="nav-link nav-link_rline" href="#"><span
                    ...
                    "prevEl": ".modal-dialog.quick-view .product-single__media .swiper-button-prev"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="{{ asset('frontend/assets/images/products/quickview_1.jpg') }}" alt="" />
                                </div>
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="{{ asset('frontend/assets/images/products/quickview_2.jpg') }}" alt="" />
                                </div>
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="{{ asset('frontend/assets/images/products/quickview_3.jpg') }}" alt="" />
                                </div>
                                <div class="swiper-slide product-single__image-item">
                                    <img loading="lazy" src="{{ asset('frontend/assets/images/products/quickview_4.jpg') }}" alt="" />
                                </div>
                            </div>
                ...
                <div class="product-single__detail">
                    ...
                    <div class="product-single__short-desc">
                        <p>Phasellus sed volutpat orci. Fusce eget lore mauris vehicula elementum gravida nec dui.
                            Aenean aliquam
                            varius ipsum, non ultricies tellus sodales eu. Donec dignissim viverra nunc, ut aliquet
                            magna posuere
                            eget.</p>
                    </div>
                    ...
                    <div class="product-single__addtolinks">
                        ...
                        <script src="{{ asset('frontend/assets/js/details-disclosure.js') }}" defer="defer"></script>
                        <script src="{{ asset('frontend/assets/js/share.js') }}" defer="defer"></script>
                    </div>
            ...
            <div class="row p-0 m-0">
                <div class="col-md-6 p-0 d-none d-md-block">
                    <div class="newsletter-popup__bg h-100 w-100">
                        <img loading="lazy" src="{{ asset('frontend/assets/images/blog/new3.jpg')}}" class="h-100 w-100 object-fit-cover d-block"
                            alt="" />
                    </div>
                </div>
...
<script src="{{ asset('frontend/assets/js/plugins/jquery.fancybox.js')}}"></script>
